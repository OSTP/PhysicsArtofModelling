...
\question[0cm]{You are about to start climbing a frictionless mountain when a spherical rock suddenly rolls passed you down the mountain (without slipping) with a speed of $\SI{200}{\meter\per\second}$. If the mountain has an average of a $15^\circ$ slope, how tall is it?}
