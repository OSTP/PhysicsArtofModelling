...
\capfig{0.4\textwidth}{figures/MagneticForce/loopfield.png}{\label{fig:magneticforce:loopfield}The magnetic field lines moving through the centre of the circle are identical to those of.}
...
\begin{checkpoint}{}
	\capfig{0.45\textwidth}{figures/MagneticForce/horseshoemagnet.png}{\label{fig:magneticforce:horseshoemagnet}A current carrying wire moving through a magnetic field.}
...
\end{align*}
\capfig{0.3\textwidth}{figures/MagneticForce/bentwire.png}{\label{fig:magneticforce:bentwire}The magnetic force on a curved current-carrying wire is obtained by modeling the forces from infinitesimal sections of wire, each with length $d\vec l$, and summing together those forces to get the total force on the wire.}

\begin{example}{\label{ex:magneticforce:semicircle}A wire carrying current, $I$, is bent so as to have semi-circular section with radius, $R$, as shown in Figure \ref{fig:magneticforce:semicircle}. The wire is immersed in a uniform magnetic field, $\vec B$, that is perpendicular to the plane of the wire, as shown. Using the given coordinate system, what is the net force on the wire?\capfig{0.4\textwidth}{figures/MagneticForce/semicircle.png}{\label{fig:magneticforce:semicircle}A current-carrying wire with a semi-circular section is immersed in a uniform magnetic field.} }
...
\begin{studentOpinion}{Josh}{}
	It is very important to remember what each part of the right-hand rule represents. A trick that I've used to remember what each part of the hand represents is to say it aloud when extending each finger. I say "velocity" as I extend my index finger, "field" as I extend my middle finger, and "force" as I extend my thumb. When doing the right hand rule, it is also important to remember the $q$ in the equation $\vec F_B = q\vec v \times \vec B$. This $q$ could be negative, which would mean that the force acts in the opposite direction.
	\capfig{0.55\textwidth}{figures/MagneticForce/rhr.png}{\label{fig:magneticforce:rhr}The way that Josh remembers the right hand rule for magnetism.}
...
\capfig{0.65\textwidth}{figures/MagneticForce/dcmotor.png}{\label{fig:magneticforce:dcmotor}Illustration of a DC electric motor. Current circulate in the coil resulting in a torque from the magnetic field. Once the coil is aligned with the magnetic field, the direction of the current in the coil is inverted, so that the coil continues to feel a torque. The current is inverted using mechanical brushes that reverse the leads on the coil every half turn.}
...
\capfig{0.7\textwidth}{figures/MagneticForce/crt.png}{\label{fig:magneticforce:crt}Illustration of a cathode ray tube from a side view (top) and a birds-eye view (bottom). A magnetic field is used to deflect a beam of electrons onto a screen. The beam is rapidly swept across the whole screen to create an image.}
...
\capfig{0.6\textwidth}{figures/MagneticForce/speaker.png}{\label{fig:magneticforce:speaker}Illustration of a loud speaker. As current moves through the coil, it is pushed up and down by the magnetic force exerted by a permanent magnet. The motion is transferred to a membrane that move the air and creates the sound wave.}
...
\begin{solution}{prob:template:ballistic}\label{soln:template:ballistic}
	...
	\capfig{0.6\textwidth}{figures/MagneticForce/proof1.png}{\label{fig:magneticforce:proof1}A current carrying wire in a magnetic field.}
	...
	\capfig{0.6\textwidth}{figures/MagneticForce/proof2.png}{\label{fig:magneticforce:proof2}A current carrying wire in a magnetic field.}
