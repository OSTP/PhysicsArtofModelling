...
A cable carries two currents in opposite directions, as shown in Figure %todo. The inner-most wire has a current of $j_1 = \SI{0.25}{A}$ and a radius of $R_1 = \SI{0.02}{m}$. The second wire is seperated from the first wire by an insulator which has a radius $R_2 = \SI{0.03}{m}$. If th second wire has a radius of $r_3 = \SI{0.045}{m}$ and a current of $j_2 = \SI{0.1}{A}$, then what is the magnetic field...
