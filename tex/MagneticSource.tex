...
The first wire will create a magnetic field, $\vec B_1$, in the shape of circles concentric with the wire. 

This magnetic field will exert a force on the second wire, carrying current, $I_2$. 

If another current-carrying straight wire is placed next to the first wire, it will experience a magnetic force from the magnetic field from the first wire. By Newton's Third Law, we also expect that the first wire will experience an equal and opposite force (resulting from the magnetic field of the second wire). 
