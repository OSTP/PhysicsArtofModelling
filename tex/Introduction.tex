...
\begin{checkpoint}
\begin{MCquestion}{Albert Einstein's postulation of General Relativity was useful in explaining the precession of Mercury because:}
...
\item Fill in the following blanks: \capfig{0.6\textwidth}{figures/Introduction/fillintheories.png}{\label{fig:Introduction:fillintheories}}
\end{enumerate}
