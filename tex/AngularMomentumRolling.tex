...
\begin{definitions}
	\textbf{Angular momentum:} The cross product of the vector from the point of rotation of a particle ($\vec r$) and the linear momentum ($\vec p$). SI units: [\SI{}{kgm^2s^{-1}}]. Common variable(s): $\vec L$.
\end{definitions}
