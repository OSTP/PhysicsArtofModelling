...
\end{align*}
where $v'_{i} = \vec\omega \times \vec r_i$ is the velocity of particle $i$ in the centre of mass frame of reference. But the sum:
\begin{align*}
...
Instead of modelling the motion of the disk  as rotation about the centre of mass and translation of the centre of mass, we can also model it about the instantaneous axis of rotation.
...
We can consider the rotation axis to be vertical through the centre of the skater. When the figure skater is spinning, there is no net external torque on him. Thus, his angular momentum is conserved as he brings his arms in. As he brings his arms in, his moment of inertia decreases, since he is bringing the mass of his arms closer to the axis of rotation. If $I_1$ and $I_2$ are the moments of inertia of the skater before and after bringing his arms in, respectively, we can write the angular momentum about his axis of rotation as:
\begin{align*}
L_1 &= I_1\omega_1\\
L_2 &= I_2\omega_2
\end{align*}
...
\capfig{0.5\textwidth}{figures/AngularMomentumRolling/kepler.png}{\label{fig:angularmomentumrolling:kepler}The area swept out by a planet in a period of time $dt$. }
...
\item Does conservation of angular momentum play a role in being able to remain upright on a bicycle? If yes, how?
