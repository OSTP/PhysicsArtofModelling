...
%TODO Much better figures for the archers, use actual people, train, etc!
...
%TODO Much better figures for Alice and Brice on the platform and the trains!
...
%TODO better figure! Show spaceship with Alice in it, see Gravity chapter for a better Earth and Sun.
...
%TODO A proton has a kinetic energy of 10MeV, how far does it travel when a) 1s go by in the proton's reference frame, b) when 1s goes by in the lab reference frame
