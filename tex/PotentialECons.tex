...
\end{align*}
This is what we generally call the ``conservation of energy''. If there are no non-conservative forces doing work on an object, its mechanical energy is conserved (i.e. constant). 
