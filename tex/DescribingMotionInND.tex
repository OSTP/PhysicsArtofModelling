...
\capfig{0.7\textwidth}{figures/DescribingMotionInND/HurdleQuestion.png}{\label{fig:describingmotioninnd:hurdlequestion} Ethan wants to clear a \SI{0.5}{m} hurdle and has an initial velocity $\vec v_0$ with $x$ and $y$ components.}
