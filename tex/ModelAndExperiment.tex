...
\end{align*}
Solving the system of equations, we find that $x=1/5$, $y=-1/5$, and $z=2/5$. 
...
\centering
\begin{tabular}{ll}
\parbox[t]{7.62cm}{\textbf{Type of measurement}} & \parbox[t]{7.62cm}{\textbf{How to determine central value and uncertainty}} \\
\hline
\parbox[t]{7.62cm}{Repeated measurements} & \parbox[t]{7.62cm}{Mean and standard deviation} \\
\hline
\parbox[t]{7.62cm}{Single measurement with a graduated scale\\(e.g. ruler, digital scale, analogue meter)} & \parbox[t]{7.62cm}{Closest value and half of the smallest division} \\
\hline
\parbox[t]{7.62cm}{Counted quantity} & \parbox[t]{7.62cm}{Counted value and square root of the value} \\
\hline
\end{tabular}
...
\begin{tabular}{ll}
\hline
\parbox[t]{7.62cm}{\textbf{Situation}} & \parbox[t]{7.62cm}{\textbf{Source of Error}} \\
\hline \hline
\parbox[t]{7.62cm}{While taking measurements, your line of sight was not completely parallel to the measuring device.} & 
\parbox[t]{7.62cm}{This is parallax error - a type of systematic error.} \\
\hline
\parbox[t]{7.62cm}{You incorrectly performed calculations.} & 
\parbox[t]{7.62cm}{Mistake! Redo the calculations.} \\
\hline
\parbox[t]{7.62cm}{A draft of wind in the lab slightly altered the direction of your ball rolling down an incline.} & 
\parbox[t]{7.62cm}{This is an environmental effect/error - it could be random or systematic, depending on whether it always had the same effect.} \\
\hline
\parbox[t]{7.62cm}{Your hand slipped while holding the ruler - the object was measured to be twice its original size!} & 
\parbox[t]{7.62cm}{Mistake! Redo this experiment and discard the data.} \\
\hline
\parbox[t]{7.62cm}{When timing an experiment, you don't hit the ''STOP'' button exactly when the experiment stops.} & 
\parbox[t]{7.62cm}{Reaction time error - usually a systematic error (time is usually measured longer than it is).} \\
\hline
\end{tabular}
