...
\begin{example}{During a physics lecture, you look under your seat and find a sheet containing data from what seems to be a juggling experiment.
...
Unfortunately, the students spilled ketchup on the left hand side of their equation, making it illegible. Luckily, you're proficient in unit analysis. What variable were the students trying to calculate, based on this model?}
