...
Therefore, the students were calculating length. In the experimental context, we can see that they were attempting to determine the distance that the ball would travel before stopping.
