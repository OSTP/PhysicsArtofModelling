...
\vspace{10pt}
\begin{mdframed}[]\relax \begin{itemize}[label=\textcolor{TBblue}{\textbullet}] #1 \end{itemize}}{%
\end{mdframed}}
...
\mdfsetup{%
    frametitle={%
        ...
        {\strut #1's Thoughts};},
    frametitlefont=\color{white}\sffamily\bfseries,
    innertopmargin=0pt,linecolor=TBorange,%
    linewidth=1pt,topline=true,%
    frametitleaboveskip=\dimexpr-\ht\strutbox\relax%
}
\vspace{10pt}
...
\newenvironment{solution}[2]{\textbf{Solution to problem #1:} #2}
{\vspace{2ex}}


%%Environments to be deleted once we transfer to new environments
%%MC checkpoint
\newenvironment{checkpointMC}[1]{\refstepcounter{checkpoint}%
...
\newenvironment{checkpointSA}[1]{\refstepcounter{checkpoint}%
    \textbf{Checkpoint \thecheckpoint: }#1\\}{}
...
%%Student opinion EN
\newenvironment{studentopinion}[1]{\refstepcounter{checkpoint}%
...
%%Student opinion OW
\newenvironment{studentopinionOW}[1]{\refstepcounter{checkpoint}%
...
\newenvironment{reflectresearch}[1]{\refstepcounter{checkpoint}%
...
%%Environments that can be deleted now (probably)
