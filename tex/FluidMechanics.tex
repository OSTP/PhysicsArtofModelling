...
\begin{definitions}
	\textbf{Pressure:}
	\item A measurement of force per unit area. SI units: \SI{}{Pa}. Common variable(s): $P$.
	\medskip
	\item \textbf{Viscosity:}
	\item A measurement of a fluid's resistance to deformation. SI units: \SI{}{Pas}. Common variable(s): $\eta$.
	\medskip
	\item \textbf{Flow rate:}
	\item A volume per second measurement of a fluid's movement. SI units: \SI{}{m^3s^{-1}}. Common variable(s): $Q$.
	\medskip
\end{definitions}
