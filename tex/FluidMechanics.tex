...
TODO: Example of continuity, maybe increase speed on airfoil?
...
\capfig{0.3\textwidth}{figures/FluidMechanics/viscosity.png}{\label{fig:fluidmechanics:viscosity}A fluid placed between a moving plate (top) and a fixed plate (bottom) in order to measure the viscosity of the fluid.}
