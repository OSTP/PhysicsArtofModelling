...
\begin{opening}
\begin{MCquestion}{A question shower curtain?}
\item a choice
...
\begin{checkpoint}
\capfig{0.3\textwidth}{figures/FluidMechanics/straw.png}{\label{fig:fluidmechanics:straw}Holding water in a vertical straw.}
...
\begin{align*}
\Delta m = V_2 \rho = A_2 l_2 \rho = A_2 v_2 \Delta t \rho \begin{flushright}
•
\end{flushright}
\end{align*}
...
TODO: This is also the principle that describes how the wind passing by the sail of a sail boat can result in a force on the boat with a component that can move the boat upwind.
