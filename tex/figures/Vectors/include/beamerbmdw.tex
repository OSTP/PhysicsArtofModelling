...
%%%%%%%%%%%% General settings
\setbeamercolor{frametitle}{fg=corange}
...
\setbeamertemplate{itemize subitem}{\color{cblue}$\circ$}
\setbeamertemplate{itemize subsubitem}{\color{cblue}$\cdot$}
\setbeamercolor{itemize item}{bg=cblue,fg=cblue}
\setbeamercolor{enumerate item}{bg=cblue,fg=cblue}
...
\setbeamercolor{block body}{bg=cblue!10}
\setbeamerfont{block body}{size=\scriptsize}
\setbeamerfont{block title}{size=\scriptsize}
%Alert block
\setbeamercolor{block title alerted}{bg= orange, fg=white}
\setbeamercolor{block body alerted}{bg=corange!10}
...
\setbeamertemplate{footline}
{
  ...
  \begin{beamercolorbox}[wd=.33\paperwidth,ht=2.25ex,dp=1ex,center]{author in head/foot}%
    \color{cblue}{\inserttitle}
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.33\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    \color{cpurple}{\insertshortauthor}, \insertdate
  \end{beamercolorbox}
  \begin{beamercolorbox}[wd=.33\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    \hspace{.28\paperwidth}\color{corange} \insertframenumber{} / \inserttotalframenumber\hspace*{1ex}
  \end{beamercolorbox}
  }%
  \vskip0pt%
}
...
\setbeamertemplate{title page}
{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \draw[color=cblue,line width=\barh] ([yshift=-0.5*\barh]current page.north west) -- ([yshift=-0.5*\barh,xshift=-0.67\paperwidth]current page.north east);
    \draw[color=cpurple,line width=\barh] ([yshift=-0.5*\barh,xshift=-0.67\paperwidth]current page.north east) -- ([yshift=-0.5*\barh,xshift=-0.34\paperwidth]current page.north east);
    \draw[color=corange,line width=\barh] ([yshift=-0.5*\barh,xshift=-0.34\paperwidth]current page.north east) -- ([yshift=-0.5*\barh]current page.north east); 
  
    \draw[color=cblue,line width=\barh] ([yshift=0.5*\barh]current page.south west) -- ([yshift=0.5*\barh,xshift=-0.67\paperwidth]current page.south east);
    \draw[color=cpurple,line width=\barh] ([yshift=0.5*\barh,xshift=-0.67\paperwidth]current page.south east) -- ([yshift=0.5*\barh,xshift=-0.34\paperwidth]current page.south east);
    \draw[color=corange,line width=\barh] ([yshift=0.5*\barh,xshift=-0.34\paperwidth]current page.south east) -- ([yshift=0.5*\barh]current page.south east);
  ...
  \usebeamerfont{date}\usebeamercolor[fg]{author}\insertdate\par
...
\setbeamertemplate{frametitle}{%
    \nointerlineskip%
        \par\hspace*{-\dimexpr0.5\paperwidth-0.5\textwidth}\textcolor{cblue}{\rule{0.33\paperwidth}{6pt}}\textcolor{cpurple}{\rule{0.33\paperwidth}{6pt}}\textcolor{corange}{\rule{0.34\paperwidth}{6pt}} 
