...
\begin{problem}{soln:gravity:fieldrod}{\label{prob:gravity:fieldrod}What is the field due to a thin uniform rod of mass $M$ at point $P$, which is a distance $d$ above the midsection of the rod (Figure \ref{fig:gravity:rodfield})
Hint: TODO
