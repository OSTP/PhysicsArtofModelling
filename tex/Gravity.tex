...
You have probably seen images of astronauts floating around the International Space Station (ISS) or other orbiting vessels, and heard of the term weightlessness. The ISS is in orbit at an altitude of approximately $\SI{400}{km}$ where the force of Earth's gravity is far from negligible (in Example \ref{ex:gravity:gofr} we showed that one needs to go to an altitude of $\SI{2640}{km}$ for the force to be reduced by half of that at the surface). The contradiction is resolved by understanding that the popular term ``weightless'' is in fact imprecise from a physics perspective, since the astronauts clearly still have a non-negligible weight from Earth's gravity.
