...
&=\frac{G\lambda}{d}\left[\frac{x}{x^2+d^2}\right]_{-L/2}^{L/2}\\
&=\frac{G\lambda}{d}\left[\frac{L/2}{(L/2)^2+d^2}-\frac{-L/2}{(L/2)^2+d^2}\right]\\
g(x)&=\frac{G\lambda}{d}\left[\frac{L}{(L/2)^2+d^2}\right]
\end{align*}
