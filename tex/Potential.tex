...
\begin{studentOpinion}{Josh}
	...
	V_E&=\frac{U_E}{q}
	\end{align*}
	This comparison is illustrated in Figure \ref{fig:gauss:gravvselec}
	\capfig{0.6\textwidth}{figures/Potential/gravvselec.png}{\label{fig:potential:gravvselec}Gravitational potential energy and gravitational potential (left) next to its electrical analog (right).}
...
\capfig{0.5\textwidth}{figures/potential/1pos.png}{\label{fig:potential:1pos}Electric potential heat map of a single positive charge.}
...
\capfig{0.7\textwidth}{figures/Potential/polarizeddipoles.png}{\label{fig:potential:polarizeddipoles} Unpolarized dipoles between two charged plates (top) and polarized dipoles between two charged plates (bottom).}
...
\begin{solution}{prob:template:nestedcylinders}\label{soln:template:nestedcylinders}
	...
	To begin, we must apply Gauss' law to find the electric field for r where $a\geq r\geq b$, which is shown in Figure \ref{fig:potential:nestedcylinderssolution}:
	\capfig{0.7\textwidth}{figures/Potential/nestedcylinderssolution.png}{\label{fig:potential:nestedcylinderssolution}Solving for $E$ between two cylinders using Gauss' law.}
	 The diagram in Figure \ref{fig:potential:nestedcylinderssolution} shown that the cylinder of radius $a$ will carry the only enclosed charge between points $a$ and $b$, so we can determine the following:
	\begin{align*}
