...
%TODO Add a figure for this example, showing the two points (can probably just modify the figure for this geometry from Gauss chapter)
...
%TODO Figure showing polarized molecules reducing the electric field, see Giancolli on Capacitors for inspiration
