...
%
\begin{checkpoint}
	\begin{MCquestion}{If we defined a gravitational potential, V(h), for particles a small distance, $h$, from the surface of the Earth, it would have the form:}
		\item $V(h) = mgh + C$.
