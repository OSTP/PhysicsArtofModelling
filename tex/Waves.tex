...
\begin{definitions}
\textbf{Wavelength:}
\item The distance between two successive maxima ("peaks") or minima (troughs) in a wave. SI units: \SI{}{m}. Common variable(s): $\lambda$.
\medskip
\item \textbf{Amplitude:}
\item The maximal distance that a particle in a medium is displaced from its equilibrium position. SI units: \SI{}{m}. Common variable(s): $A$.
\medskip
\item \textbf{Frequency:}
\item The number of cycles of oscillatory motion that occur in one second. SI units: \SI{}{s^{-1}}. Common variable(s): $f$.
\medskip
\item \textbf{Bulk modulus:}
\item A measurement of an object or substance's resistance to compression. SI units: \SI{}{Pa}. Common variable(s): $B$.
\medskip
\item \textbf{Volume mass density:}
\item The mass per unit volume of an object.. SI units: \SI{}{kgm^{-3}}. Common variable(s): $\rho$.
\medskip
\item \textbf{Intensity:}
\item The power per unit area transmitted by a wave. SI units: \SI{}{Wm^{-2}}. Common variable(s): $I$.
\medskip
\end{definitions}
\newpage
