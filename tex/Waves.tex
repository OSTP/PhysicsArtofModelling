...
\begin{itemize}
\item The \textbf{wavelength}, $\lambda$, is the distance between two points along the wave that have the same displacement from their equilibrium position. For example, it can be the distance between two successive maxima (``peaks'') or minima (``troughs'') in the wave. TODO: I thought it was just 2 maxima or minima - if its two sucessive points at equilibrium it would only be half a wavelength.
...
TODO: Why isnt the pulse reflected?
\begin{checkpoint}
