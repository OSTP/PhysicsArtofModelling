...
\begin{checkpoint}
\begin{MCquestion}{A standing wave (composed of two travelling waves) has an amplitude $A$. What must the amplitude $A_0$ of each travelling wave be? }
\item $A_0=1/4 A$
...
\begin{checkpoint}
\begin{MCquestion}{How does the energy in one wavelength of a standing wave, $E_s$, compare to the energy in one wavelength of a travelling wave, $E_T$, if both waves have the same amplitude?}
\item $E_s=1/4 E_T$
\item $E_s=1/2 E_T$ \correct
\item $E_s=E_T$
\item $E_s=2E_T$
\item $E_s=4E_T$
\end{MCquestion}
