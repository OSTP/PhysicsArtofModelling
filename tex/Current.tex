...
\item Determine the current in your house's electrical outlets. Is this a dangerous?
\item determining current of a phone produced by the battery? total power held in a battery?
\item Try
...
{ 
\item Propose an experiment to (AC/oscilloscope question? Something along those lines.)
\item 
...
%TODO A problem where the resistance of a resistor is given at 2 different temperatures, and you have to find the material by looking at the table of alpha values

%TODO Total current if the current density depends on position (i.e. have to do an integral)? OR power dissipated by some combination of appliances?


\subsection{Problems}
\begin{problem}{soln:template:ballistic}{\label{prob:template:ballistic} 
You have your washing machine, television, and dish washer connected to the same circuit. You would like to use the vacuum, but aren't sure if it will draw too much power... (rest of power dissipation question...)

OR

The current along a square conductor with a side length of \SI{0.5}{cm} can be described as $\vec j = xy$. What is the total current travelling in the $y$ direction?  %This is a good one, I like this one.
...
\begin{problem}{soln:template:ballistic}{\label{prob:template:ballistic} 
		A resistor has a resistance of x at a temperature of x and has a resistance of x at a temperature of x. What material is this resistor made of?
	}
\end{problem}
