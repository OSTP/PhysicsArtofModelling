...
\capfig{0.25\textwidth}{figures/AppendixB/vector3d.png}{\label{fig:appB:vector3d}Geometric representation of three vectors. The vector $\vec a$ lies in the plane of the page, the vector $\vec b$ is pointing out of the page, and the vector $\vec c$ is pointing into the page.}
...
\capfig{0.3\textwidth}{figures/AppendixB/xydvec.png}{\label{fig:appB:xydvec}Illustration of a displacement vector, $\vec d = \vec r_2 -\vec r_1$, for an object that was located at position $\vec r_1$ at time $t_1$ and at position $\vec r_2$ at time $t_2$.}
...
\capfig{0.3\textwidth}{figures/AppendixB/work_scalarprod.png}{\label{fig:appB:work_scalarprod}Example of a force $\vec F$ being applied on an object as it moves along the displacement vector $\vec d$.}
...
\capfig{0.3\textwidth}{figures/AppendixB/torque_vectorprod.png}{\label{fig:appB:torque_vectorprod}A force, $\vec F$, is exerted in the plane of a disk at a position given by the vector $\vec r$ relative to the centre of the disk.}
