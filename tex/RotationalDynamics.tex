...
\begin{opening}
\begin{MCquestion}{A construction worker has to turn a lever at an angle of 55$^{\circ}$. The length of the lever is $\SI{0.61}{m}$ long and is a force of $\SI{25}{N}$ is exerted to turn it. What is the net torque on the lever?}
\item $\SI{9.0}{Nm}$
\item $\SI{34}{Nm}$
\item $\SI{12}{Nm}$ %correct
\item $\SI{22}{Nm}$
\end{MCquestion}
\end{opening}
...
\begin{review}
Before proceeding, you may wish to review the section \ref{subsec:Vectors:rotationalmotion} on rotational kinematics and vector products.
\end{review}
...
\begin{checkpoint}
\begin{MCquestion}{Which of the following statements correctly describes the speeds at points A and B on the following rotating disk?
...
\capfig{0.5\textwidth}{figures/RotationalDynamics/righthandruleaxial.png}{\label{fig:rotationaldynamics:hand} Using the right hand rule for axial quantities. In this case, the direction of rotation is counter clockwise when looking at the page (the direction that the fingers curl), so the rotation vector points out of the page (the direction of the thumb).}
...
\begin{checkpoint}
\begin{MCquestion}{You push on the right-hand side of a door to open it, as the door's hinges are on the left. The angular velocity of the door is:}
...
\capfig{0.40\textwidth}{figures/RotationalDynamics/ant.png}{\label{fig:rotationaldynamics:ant} An ant on a disk.}
}
...
Next, you should try pushing on the top of the eraser of your pencil. Now, try pushing on the side of the eraser of your pencil. Pushing on the side should make it spin with ease, as you are applying the force from the perpendicular.
...
\begin{review}
Before proceeding, you may wish to review the section \ref{subsec:NewtonsLaws:inertialforces} on inertial forces.
\end{review}
...
\item What is a gyroscope, and how does it work?
\end{enumerate}
