...
TODO: Review box to rotational kinematics, and vector product. (Note: The vector section on the right hand rule is labelled subsec:Vectors:rotationalmotion)
