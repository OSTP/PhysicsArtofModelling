...
\item Newton's Three Laws are a theory of classical physics.
\item Newton's First Law allows inertial frames to be defined.
...
\item Newton's Third Law states that for every action force there is a reaction force on a different object.
\item Newton's Theory introduces the concept of a force, which is a mathematical tool.
