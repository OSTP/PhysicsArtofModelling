...
\end{problemParts}
\capfig{0.2\textwidth}{figures/NewtonsLaws/threeboxes.png}{\label{fig:newtonslaws:threeboxes} Three stacked boxes.}
\newpage
...
\begin{solution}{prob:newtonslaws:threeboxes}\label{soln:newtonslaws:threeboxes}In order to determine what happens to boxes 1 and 2, we first need to draw free body diagrams for all of the boxes.

\capfig{0.6\textwidth}{figures/NewtonsLaws/FBD123.png}{\label{fig:newtonslaws:FBD123} Forces on boxes 1, 2 and 3.}
...
Analyzing the horizontal forces on box 1's free body diagram,
\begin{align*}
...
\capfig{0.6\textwidth}{figures/NewtonsLaws/FBD23.png}{\label{fig:newtonslaws:FBD23}}
...
Before we can solve for the maximum force, we see that we need the normal force on boxes 2 and 3. We can proceed by evaluating the normal force on box 3:
