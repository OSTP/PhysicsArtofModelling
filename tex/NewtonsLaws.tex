...
\begin{itemize}
\item Points towards the centre of the Earth.
\item Has a magnitude of $F_g=mg$, where $g$ is the magnitude of the Earth's gravitational field, and in most locations on Earth has a value of approximately $g=\SI{9.8}{N/kg}$.
\end{itemize}
