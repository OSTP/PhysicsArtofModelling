...
Consider the junction illustrated in Figure \ref{fig:circuits:junction}, comprised of 5 segments of wire, each carrying a different current. As shown, currents $I_1$ and $I_4$ flow into the junction, whereas currents $I_2$, $I_3$ and $I_5$ all flow out of the junction. 
...
\subsection{problems}
\begin{problemParts}{soln:circuits:ballistic}{\label{prob:circuits:ballistic} 
...
\begin{problem}{soln:circuits:ballistic}{\label{prob:circuits:ballistic}}
...
\begin{solutionParts}{prob:circuits:ballistic}
{\label{soln:circuits:ballistic}
