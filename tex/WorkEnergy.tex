...
\capfig{0.6\textwidth}{figures/WorkEnergy/skiprobdisplacement.png}{\label{fig:workenergy:skijumpprobdisplacement} The displacement of the skier after they leave the jump.}
