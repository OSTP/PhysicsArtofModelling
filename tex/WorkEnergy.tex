...
TODO: Checkpoint question: work done by tension in a pendulum (zero, since always perpendicular to motion)

TODO: Checkpoint question: work done by your arm in holding up a heavy book (no displacement, no work, even if it's tiring!)
...
\begin{example}{\label{ex:workenergy:workgravity}\capfig{0.5\textwidth}{figures/WorkEnergy/workgravity.png}{\label{fig:workenergy:workgravity}Two possible paths to move a box from the floor onto a table. }
