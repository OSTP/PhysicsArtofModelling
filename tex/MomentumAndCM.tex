...
\begin{definitions}
	...
	\textbf{Momentum:}
	\item The product of velocity and mass. SI units: \SI{}{kgms^{-1}}. Common variable(s): $\vec p$.
	\medskip
	
	\item \textbf{Impulse:}
	\item A property of matter which describes an object's resistance to rotational motion. SI units: \SI{}{Ns}. Common variable(s): $\vec J$.
	\medskip
