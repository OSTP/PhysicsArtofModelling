...
\label{sec:c2:determiningerrors}
...
In Appendix \label{chap:app:python}, we will show you how to very easily calculate uncertainties using a computer, so that you do not have to worry about applying the derivative method. 
