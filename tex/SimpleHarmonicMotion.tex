...
\begin{itemize}
\item Changing the phase, $\phi$, results in a horizontal shift of the functions. A positive phase results in a shift of the functions to the left.
