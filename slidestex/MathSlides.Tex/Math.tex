...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\twocolframe{Math - Directory}
{
\begin{itemize}
\item Intro \ref{sec:outline}
\vspace{1cm}
\item Vectors
\begin{itemize}
\item Coordinate systems \ref{sec:coordinatesystems}
\item Vector basics \ref{sec:vectorbasics}
\item Scalar product \ref{sec:scalarproduct}
\item Cross product \ref{sec:crossproduct}
\item Rotational vectors \ref{sec:rotationvectors}
...
\item Derrivatives 
\begin{itemize}
\item Functions \ref{sec:functions}
\item The derrivative \ref{sec:thederrivative}
\item How to find the derrivative \ref{sec:howtofindder}
\item Multivariable functions \ref{sec:multvarfuncs}
\item The gradient vector \ref{sec:gradientvector}
...
\begin{itemize}
\item Finding the mass of a rod \ref{sec:rodexamples}
\item The anti-derrivative \ref{sec:antider}
\item Definite and indefinite integrals \ref{sec:indefanddefintegrals}
\item Finding the antiderivative \ref{sec:determiningantider}
\item Solving the mass of a non-uniform rod \ref{btpnonunirodmass}
\end{itemize}
...
\section{Outline}
\label{sec:outline}
\twocolframe{Outline for the semester}
{
\vspace{-0.4cm}
\begin{itemize}
\scriptsize
\item \textbf{Math}
  ...
  \scriptsize
   \item Monday: Vectors
   \item Tuesday: Derivaties
   \item Thursday: Integrals
 \end{itemize}
\item Kinematics 
\item Newton’s Laws 
\item Applying Newton’s Laws
\item Work and energy
\item Potential energy and conservation of energy
\item Gravity 
\item Momentum 
\item Rotating things 
...
To do physics:
\begin{itemize}
\item We want to describe the motion of objects.
\item We need the tools to do that:
\begin{itemize}
\item Vectors (where things are)
\item Calculus (how things change with time)
\item Kinematics (describing where things are)
\end{itemize}
\end{itemize}
\color{blue}{The \emph{quantity} of readings will decrease after RA3! We need to get the math out of the way, and everyone at a similar level, regardless of high school}
}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{In other words}
\capfig{0.4}{figures/chess}{}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%


\title{PHYS 101 - Vectors}
\institute{}
\author{Building Models to Describe our World}
\date{\today}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker questions 1,2,3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker questions 4,5}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker questions 6,7}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker question 8}
...
\capfig{1}{figures/righthandrule}{}
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker questions 9, 10}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Vectors to indicate rotation}
\label{sec:rotationvectors}
...
{
\capfig{0.75}{figures/righthandruleaxial}{}
\capfig{0.9}{figures/carwheelrotation}{}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{PHYS 101 - Derrivatives}
\institute{}
\author{Building Models to Describe our World}
\date{\today}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The Derrivative}
\label{sec:thederrivative}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker questions 4,5,6}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker question 7}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Rod Examples}
\label{sec:rodexamples}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker questions 2,3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Qlicker question 4}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The indefinite and definite integrals}
\label{sec:indefanddefintegrals}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{How to determine the anti-derivative}
\label{sec:determiningantider}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Back to physiscs: the mass of a non-uniform rod}
\label{btpnonunirodmass}
