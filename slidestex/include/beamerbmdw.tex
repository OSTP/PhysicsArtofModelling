...
\usepackage{cancel}%can add arrow to cancel a term, \cancelto{0}{\phi}
\usepackage{hyperref}
...
\newcommand{\pvec}[1]{\vec{#1}\mkern2mu\vphantom{#1}} %for vectors

\makeatletter                                                     %renew \subject command and \insertsubject
...
\makeatletter
% Save the original \subsection command
\let\oldbeamer@subsection\subsection

% Redefine \subsection to store the raw title
\renewcommand{\subsection}[1]{%
  \def\@rawsubsection{#1}%
  \oldbeamer@subsection{#1}%
}

% Define a macro to retrieve the raw subsection title
\newcommand{\insertrawsubsection}{\@rawsubsection}
\makeatother
\subsection{} %define it initially so it can be recalled later, since it is outside of a section it should not cause issues
...
\newcommand{\chaptertitle}[1]{%
  \stepcounter{chapter}%
  \expandafter\def\csname chaptertitle@\thechapter\endcsname{#1}%
...
% Create a hyperlink to the chapter
\newcommand{\chapterlink}[1]{%
  \hyperref[chapter:#1]{\getchaptertitle{#1}}%
}
...
\definecolor{poolgreen}{RGB}{35,117, 15}

%%%%%%%%%%%% General settings
\setbeamercolor{frametitle}{fg=black}
\setbeamercolor{title}{fg=black}
\setbeamercolor{subtitle}{fg=myblue2}
...
\setbeamerfont{subject}{series=\bfseries,size=\footnotesize,parent=structure}
...
%\begin{beamercolorbox}[wd=.25\paperwidth,ht=2.25ex,dp=1ex,left]{author in head/foot}%
 %   \color{black}{\hspace{0.5cm}\insertsubject}
%\end{beamercolorbox}
  \begin{beamercolorbox}[wd=.75\paperwidth,ht=2.25ex,dp=1ex,left]{author in head/foot}%
    \color{black}{\hspace*{0.5cm}\inserttitle : \insertrawsubsection}
  \end{beamercolorbox}%
...
%  \end{beamercolorbox}
  \begin{beamercolorbox}[wd=.25\paperwidth,ht=2.25ex,dp=1ex,right]{title in head/foot}%
    \hspace{.28\paperwidth}\color{black} \insertframenumber{} / \inserttotalframenumber\hspace*{0.5cm}
  \end{beamercolorbox}
  }%
  \vskip0pt%
}
...
\setbeamertemplate{title page}
{
  ...
  \usebeamerfont{subject}\usebeamercolor[fg]{subtitle}\insertsubject\par
  \usebeamercolor[fg]{subject}\par
