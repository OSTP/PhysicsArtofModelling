...
\setbeamercolor{section in toc}{fg=myblue2}
\setbeamercolor{subsection in toc}{fg=cblue}
\setbeamerfont{section in toc}{series=\bfseries}
\setbeamercolor{navigation symbols}{fg=myblue2}

%%%%%%%%%%%% General settings
\setbeamercolor{frametitle}{fg=black}
\setbeamercolor{title}{fg=black}
\setbeamercolor{author}{fg=cblue}
...
%Alert block
\setbeamercolor{block title alerted}{bg= cblue, fg=white}
\setbeamercolor{block body alerted}{bg=cblue!10}
...
\setbeamertemplate{title page}
{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \draw[color=cblue,line width=\barh] ([yshift=-0.5*\barh,xshift=-0.67\paperwidth]current page.north east) -- ([yshift=-0.5*\barh,xshift=-0.34\paperwidth]current page.north east);
    \draw[color=cblue,line width=\barh] ([yshift=-0.5*\barh,xshift=-0.34\paperwidth]current page.north east) -- ([yshift=-0.5*\barh]current page.north east); 
    ...
    \draw[color=cblue,line width=\barh] ([yshift=0.5*\barh,xshift=-0.67\paperwidth]current page.south east) -- ([yshift=0.5*\barh,xshift=-0.34\paperwidth]current page.south east);
    \draw[color=cblue,line width=\barh] ([yshift=0.5*\barh,xshift=-0.34\paperwidth]current page.south east) -- ([yshift=0.5*\barh]current page.south east);
...
\setbeamertemplate{frametitle}{%
    \nointerlineskip%
        \par\hspace*{-\dimexpr0.5\paperwidth-0.5\textwidth}\textcolor{cblue}{\rule{0.33\paperwidth}{6pt}}\textcolor{cblue}{\rule{0.33\paperwidth}{6pt}}\textcolor{cblue}{\rule{0.34\paperwidth}{6pt}} 
